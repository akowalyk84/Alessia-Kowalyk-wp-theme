 ...
 */
 function alessiakowalyk_theme_scripts() {
     wp_enqueue_style( 'alessiakowalyk', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'alessiakowalyk_theme_scripts' );
...
/*  STEP 2.10 ADD THE MENUS */
 ...
 // START STEP 2.14 ADD ADDITIONAL CUSTOM FEATURES TO THE SITE THEME
    ...
    function alessiakowalyk_theme_init(){
        ...
        add_action('after_setup_theme', 'alessiakowalyk_theme_init');
    ...
    function alessiakowalyk_widgets_init() {
    ...
    add_action( 'widgets_init', 'alessiakowalyk_widgets_init' );
